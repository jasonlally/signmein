...
class MY_Controller extends CI_Controller
{
	...
	function __construct()
	{
		...
		// Note: This is only included to create base urls for purposes of this
		// demo only and are not necessarily considered as 'Best practice'.
